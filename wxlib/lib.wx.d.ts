...
/**
 *@description wexin mini program core
 */
...
declare namespace wx {
    interface API {
         ...
         */
        request(param: RequestParams): RequestTask;
        /**
         * 上传文件
         * 将本地资源上传到开发者服务器
        ...
        sendSocketMessage(message: SocketMessage & BaseParams): void;
        /**接受 WebSocket 消息 */
        onSocketMessage(callback: (res?: { data: string | ArrayBuffer }) => void): void;
        /**关闭 WebSocket 连接 */
        closeSocket(param: SocketClose & BaseParams): void;
        /**监听 WebSocket 关闭 */
        ...
        hideKeyboard(): void;
        /**停止下拉刷新动画 */
        stopPullDownRefresh(params?: BaseParams): void;
        /**
         * @since 1.5.0
         * @description 开始下拉刷新 调用后触发下拉刷新动画 效果与用户手动下拉刷新一致
         */
        startPullDownRefresh(param?: ErrmsgParams): never;
        // 开放接口
        /**登录 */
        ...
        /**检查登陆态是否过期 */
        checkSession(param: BaseParams): void;
        ...
        // 蓝牙相关
        /**初始化蓝牙适配器 */
        openBluetoothAdapter(param: BaseParams): void;
        /**关闭蓝牙模块 调用该方法将断开所有已建立的链接并释放系统资源 */
        closeBluetoothAdapter(param: BaseParams): void;
        /**获取本机蓝牙适配器状态 */
        ...
        /**停止搜寻附近的蓝牙外围设备 */
        stopBluetoothDevicesDiscovery(param: ErrmsgParams): void;
        ...
        hideLoading(): void;
        /**开始监听加速度数据 */
        startAccelerometer(param: BaseParams): void;
        /**停止监听加速度数据 */
        stopAccelerometer(param: BaseParams): void;
        /**设置系统剪贴板的内容 */
        setClipboardData(param: SetClipboardParam): void;
        /**获取系统剪贴板内容 */
        getClipboardData(param: BaseParams): void;
        /**批量添加卡券 */
        ...
        /**隐藏分享按钮 */
        hideShareMenu(param: BaseParams): void;
        /**获取分享详细信息 */
        ...
        /**开始搜索附近的iBeacon设备 */
        startBeaconDiscovery(param: ErrmsgParams): void;
        /**停止搜索附近的iBeacon设备 */
        stopBeaconDiscovery(param: ErrmsgParams): void;
        /**获取所有已搜索到的iBeacon设备 */
        ...
        /**使手机发生较长时间的振动 400ms */
        vibrateLong(param: BaseParams): void;
        /**使手机发生较短时间的振动 15ms */
        vibrateShort(param: BaseParams): void;
        ...
        /**将页面滚动到目标位置 单位px */
        pageScrollTo(callback: BaseParams & { scrollTop: number, duration?: number }): never;
        /**支持小程序修改标题栏颜色 */
