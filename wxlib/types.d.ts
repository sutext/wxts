...
declare namespace wts {
    ...
    interface wx {
        ...
        /**检查登陆态是否过期 */
        checkSession(param: Callback): void;
        ...
        closeBluetoothAdapter(param: Callback): void;
        /**获取本机蓝牙适配器状态 */
        ...
        /**隐藏分享按钮 */
        hideShareMenu(param: Callback): void;
        /**获取分享详细信息 */
        ...
        /**使手机发生较长时间的振动 400ms */
        vibrateLong(param: Callback): void;
        /**使手机发生较短时间的振动 15ms */
        vibrateShort(param: Callback): void;
    ...
    interface CanvasToTempFilePathParam extends Callback {
    ...
    interface UserInfoParam extends Callback {
        /**是否带上登录态信息
    ...
    interface RequestPaymentParam extends Callback {
    ...
    interface SwitchTabParam extends Callback {
        /**需要跳转的 tabBar 页面的路径(需在 app.json 的 tabBar 字段定义的页面) 路径后不能带参数 */
        url: string;
    }

    interface ScanCodeParam extends Callback {
    ...
    interface MapContext {
        ...
        /**获取当前地图的视野范围 */
        getRegion(param: Callback): void;
        /**获取当前地图的缩放级别 */
        getScale(param: Callback): void;
    }
    ...
    interface BluetoothAdapterStateParam extends Callback {
    ...
    interface BluetoothAdapterStateChangeParam extends Callback {
    ...
    interface BluetoothDevicesParam extends Callback {
        /**蓝牙设备主 service 的 uuid 列表 */
        services: Array<string>;
    ...
    interface ConnectedBluetoothDevicesParam extends Callback {
        /**蓝牙设备主 service 的 uuid 列表 */
        services: Array<string>;
    ...
    interface BLECharacteristicValueParam extends Callback {
        /**蓝牙设备 id 参考 device 对象 */
        deviceId: string;
        /**蓝牙服务 uuid */
        serviceId: string;
    ...
    interface AddressParam extends Callback {
    ...
    interface SettingParam extends Callback {
        success: (res: {
            /**用户信息 */
    ...
    interface ReLaunchParam extends Callback {
        /**
    ...
    interface LoadingParam extends Callback {
        /**提示的内容 */
        title: string;
        /**是否显示透明蒙层 防止触摸穿透 默认 false */
        mask?: boolean;
    ...
    interface SetClipboardParam extends Callback {
        data: string;
    }
    ...
    interface ShareInfoParam extends Callback {
        shareTicket: string;
        success: (res: {
            /**错误信息 */
            errMsg: string;
    ...
    interface ExtConfigParam extends Callback {
        success: (res: { errMsg: string; extConfig: object }) => void;
    }

    interface ShareMenuParam extends Callback {
        /**是否使用带 shareTicket 的分享 */
        withShareTicket?: boolean;
    }

    interface BeaconsParam extends Callback {
    ...
    interface GetScreenBrightnessParam extends Callback {
        success: (res?: { errMsg: string; value: number; }) => void;
    }

    interface SetScreenBrightnessParam extends Callback {
    ...
    interface GetWeRunDataParam extends Callback {
    ...
    interface GetFileInfoParam extends Callback {
        /**本地文件路径 */
        filePath: string;
        /**计算文件摘要的算法 默认值 md5 */
    ...
    interface CheckIsSupportSoterAuthenticationParam extends Callback {
        success?: (res: { supportMode: Array<'fingerPrint' | 'facial' | 'speech'>, errMsg: string; }) => void;
    }

    interface StartSoterAuthenticationParam extends Callback {
        /**请求使用的可接受的生物认证方式 */
